(function() {
  ...
  (function() {
    ...
    return window.Ani = (function() {
      ...
      Ani.prototype.wrap_prop_method = function(method_name, prop_name, func) {
        return this.add_method(method_name, __bind(function() {
          var value;
          value = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          return this.property(prop_name, new func(method_name, value));
        }, this));
      };
