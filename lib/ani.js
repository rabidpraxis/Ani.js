(function() {
  var Ani, ani_function_methods, ani_property_methods, ani_transition_methods, debug, log;
  ...
  ani_transition_methods = [['transition_delay', 'delay'], ['transition_duration', 'duration'], ['transition_iteration_count', 'iteration-count'], ['transition_timing_function', 'timing_function'], ['transition_time', 'time'], ['transition_repeat', 'repeat']];
  Ani = (function() {
    var format_css_rule, get_ani_sheet;
    function Ani(ele, options) {
      this.ele = ele;
    ...
    Ani.prototype.setup_transition_methods = function() {
      ...
      _results = [];
      for (_i = 0, _len = ani_transition_methods.length; _i < _len; _i++) {
        meth = ani_transition_methods[_i];
        self = this;
    ...
    Ani.prototype.setup_animatable_methods = function() {
      ...
      _results = [];
      for (method_name in ani_function_methods) {
        method_opts = ani_function_methods[method_name];
        self = this;
    ...
    Ani.prototype.setup_property_methods = function() {
      var method_name, method_opts, self, _results;
      _results = [];
      for (method_name in ani_function_methods) {
        method_opts = ani_function_methods[method_name];
    ...
    format_css_rule = function(prop, property_obj) {
      ...
      return ani_function_methods[prop][0].replace('%', rule_opt_str);
    };
